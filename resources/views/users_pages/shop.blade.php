                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                            ...
                                            @if (app()->getLocale() === 'ar')
                                                <h4>{{$item->name_ar}}</h4>
                                                <h5> {{$item->price}} LE</h5>
                                                @if($item->short_details_ar != "")
                                                    <p>{{$item->short_details_ar}}</p>
                                                    @else
                                                    <p>{{$item->short_details}}</p>
                                                @endif
                                                @if($item->long_details_ar != "")
                                                    <p>{{$item->long_details_ar}}</p>
                                                    @else
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            ...
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="/category/search/{{$item->id}}" aria-expanded="true" aria-controls="sub-men{{$loop->iteration}}">
                                    {{$item->title_ar}} <small class="text-muted">({{$subcategoriesCount}})</small>
                                ...
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    ...
                                    <div class="list-group">
                                        <a href="/subcategory/search/{{$subcategory->id}}" class="list-group-item list-group-item-action active">{{$subcategory->title_ar}}<small class="text-muted">({{$productCount}})</small></a>
                                    </div>
                                    @endif
                                    @endforeach
                                </div>
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            ...
                            <div class="list-group-collapse sub-men">
                                ...
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    ...
                                    @if($subcategory->category === $item->title)
                                    <div class="list-group">
                                        <a href="/subcategory/search/{{$subcategory->id}}" class="list-group-item list-group-item-action active">{{$subcategory->title}}<small class="text-muted">({{$productCount}})</small></a>
                                    </div>
                                    @endif
                                    @endforeach
                                </div>
