                    ...
                    <div class="card-body tab_data table-responsive">
                        ...
                        <table class="table datatable ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="/admin/product/delete/{{$item->id}}" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Delete <i class="bi bi-trash3"></i></a></td>
                                    <td><a href="/admin/product/edite/{{$item->id}}"  class="link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Edite <i class="bi bi-pencil-fill"></i></a></td>
